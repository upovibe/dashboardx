...
<template>
    ...
    <div v-if="isVisible" :class="[ 
        'bg-white h-screen p-5 rounded-3xl overfrlow-hidden flex flex-col transition-all duration-300 relative mr-5', 
        ...
        <!-- Menu Items -->
        <div class="flex-1">
            <div v-for="(item, index) in items" :key="index" class="transition-opacity duration-300">
                ...
                <template v-else>
                    <a v-if="item.link" :href="item.link"
                        ...
                        :class="{ 'justify-center py-3': isCollapsed }"
                    >
